...
if (isset($_SESSION['hJHVHjhshdYjhf10'])) {
    if (!empty($_SESSION['hJHVHjhshdYjhf10'])) {
...
if (isset($_POST['envoyer'])) {
    if (!empty($_POST['nom']) and !empty($_POST['email']) and !empty($_POST['motdepasse'])) {
        ...
        $user = ajouterUser($nom, $email, $motdepasse);
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="mb-3 text-center">
                                            <p class="small mb-0">Already have an account? <a href="login_users.php">Log in</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
