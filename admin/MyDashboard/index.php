                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                      <?php foreach ($Produits as $Produit) : ?>
                        <tr>
                          <td><?= $Produit->id ?></td>
                          <td><img src="<?= $Produit->image ?>" class="img-fluid" alt="Image du produit"></td>
                          <td><?= $Produit->nom ?></td>
                          <td><a href="#" class="text-primary fw-bold"><?= $Produit->prix ?>$</a></td>
                          <td ><?= substr($Produit->description, 0, 20) ?>...</td>
                          <td><a href="prod_edit.php?ptd=<?= $Produit->id ?>"><i class="bi bi-pencil" style="font-size: 20px;"></i></a></td>
                          <td>
